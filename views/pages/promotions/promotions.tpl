<section class="promotions">
    <div class="container promotions__container">
        ...
        <div class="sl-promotion__header">
            <div class="sl-promotion__header-wr">
                <h2 class="title title-2 sl-promotion__title">Акции{if ($url->lvl2 == "prodazha")} по продаже{elseif ($url->lvl2 == "arenda")} по аренде{/if}</h2>
                <p class="sl-promotion__header-txt">всего {$page->count} акций</p>
            </div>
            ...
            <div class="sl-promotion__tabs sl-promotion__tabs-mobile">
                ...
                <a class="sl-promotion__tab{if !$url->lvl2} sl-promotion__tab-active{/if}" data-sl-promotion="1" type="button" href="/promotions">Все</a>
                <a class="sl-promotion__tab{if ($url->lvl2 == "prodazha")} sl-promotion__tab-active{/if}" data-sl-promotion="2" type="button" href="/promotions/prodazha">Продажа</a>
                <a class="sl-promotion__tab{if ($url->lvl2 == "arenda")} sl-promotion__tab-active{/if}" data-sl-promotion="3" type="button" href="/promotions/arenda">Аренда</a>
            </div>
        </div>
        <div class="list list-pane list-promotion">
                    ...
                    <div class="list__item-img">
                        <picture>
                            ...
                            <img class="image cover"
                                ...
                                alt="Акция. Акция для новых арендаторов офисных помещений на Уралмаше!"
                                width="285"
                                height="190"
                                loading="lazy"
                                decoding="async" />
