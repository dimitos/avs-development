...
{block main}
    <div class="modal__inner">
        <div class="mod-request__img">
            <picture>
                <source srcset="/img/modal/repair.webp" type="image/webp" />
                <img class="image cover"
                    src="/img/modal/repair.jpg"
                    alt="Оставить заявку"
                    width="267"
                    height="516"
                    loading="lazy"
        ...
        <div class="mod-request__content">
            <h3 class="title modal-title">Оформить заявку на ремонт</h3>
            <form class="request__form">
                <div class="request__fields">
                    ...
                    <input type="hidden" class="request__from" value="Форма захвата: Оформить заявку на ремонт" />
                </div>
