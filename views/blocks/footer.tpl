            ...
            <div class="footer__content">
                <a href="/" class="logo footer-logo">
                    <picture class="about__item-img">
                        ...
                        <img class="image" src="/img/images/logo-header.png" width="115" height="43" alt="Логотип AVS" loading="lazy" decoding="async" />
                    </picture>
                </a>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-bottom__wr">
                <p class="footer-bottom__txt">Сайт не является публичной офертой. <span class="no-wrap">Управляющая компания «AVS Девелопмент»</span></p>
                <p class="footer-bottom__txt footer-bottom__txt-icon">Екатеринбург, ул. Розы Люксембург, 25, оф. 106 (продажа) и оф. 107 (аренда)</p>
            </div>
        </div>
    </div>
</footer>
