<?
    ...
    function get_page(): Page
    {
        ...
        try {
            ...
            } elseif ($url->lvl1 == "about") {
                return SimplePage::code200($url->lvl1, "О компании");
            } elseif ($url->lvl1 == "contacts") {
                return SimplePage::code200($url->lvl1, "Контакты");
            } elseif ($url->lvl1 == "investors") {
                return InvestPage::code200();
            } elseif ($url->lvl1 == "partners") {
                return SimplePage::code200($url->lvl1, "Партнерам");
            } else {
                // Страница не найдена
                return Page::code404();
            }
